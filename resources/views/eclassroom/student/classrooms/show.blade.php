...
<span class="text-slate-400 hover:cursor-pointer"> <a href={{url('/')}} id="home-nav"
        class="hover:text-blue-900">Esoma</a> | <a href={{url('classroom/student')}}
        class="hover:text-blue-900">Classrooms</a> | <a href="#" class="text-blue-rich font-normal"> {{$page}} </a>
</span>
@endsection
        ...
        <div class="flex flex-col gap-y-[80px] items-start px-10">
            ...
            <div class="flex flex-col items-start w-full ">
                ...
                <p class="font-light text-sm ml-3 mt-2 text-zinc-500">@if($results ===1)1 item available @else
                    {{$results}} items available @endif</p>
