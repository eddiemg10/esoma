...
<body>
    ...
    <div class="above-the-fold">
        <div class="main-content">
            <div><h1><span>Studying</span> online is now much easier</h1></div>
            <div><p>E-soma is an interesting platform that will teach you in an interactive way</p></div>
    ...
    <div class="below-the-fold-1">   
        ...
        <div class="below-fold-content">
            <p>We have provided a platform to enable Kenyan students to easily access learning materials. We offer an e-classroom service to allow teachers to better manage their students and classes. In addition, we offer an e-library service that allows students to access and download revision material as well as topical notes for all classes from PP1 to form 4.</p>
        </div>
        <div class="below-fold-heading">
        ...
        <div class="card-holder">
            <div class="card">
                <div class="icon-1">
                    <svg width="95" height="95" viewBox="0 0 95 95" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M95 47.5C95 73.7335 73.7335 95 47.5 95C21.2665 95 0 73.7335 0 47.5C0 21.2665 21.2665 0 47.5 0C73.7335 0 95 21.2665 95 47.5Z" fill="#0597F2"/><path d="M66 53.5625V29.9375C66 27.7629 64.2243 26 62.0357 26H36.9286C32.5497 26 29 29.5257 29 33.875V60.125C29 64.4743 32.5497 68 36.9286 68H63.3571C64.8165 68 66 66.8245 66 65.4488C66 64.4874 65.4543 63.6835 64.6786 63.2258V56.5517C65.4879 55.7609 66 54.7273 66 53.5625ZM40.8185 36.5H56.6757C57.4768 36.5 58.0714 37.0906 58.0714 37.8125C58.0714 38.5344 57.4768 39.125 56.75 39.125H40.8185C40.1661 39.125 39.5714 38.5344 39.5714 37.8125C39.5714 37.0906 40.1661 36.5 40.8185 36.5ZM40.8185 41.75H56.6757C57.4768 41.75 58.0714 42.3406 58.0714 43.0625C58.0714 43.7844 57.4768 44.375 56.75 44.375H40.8185C40.1661 44.375 39.5714 43.7844 39.5714 43.0625C39.5714 42.3406 40.1661 41.75 40.8185 41.75ZM60.7143 62.75H36.9286C35.4692 62.75 34.2857 61.5745 34.2857 60.125C34.2857 58.6755 35.4692 57.5 36.9286 57.5H60.7143V62.75Z" fill="white"/></svg>
                </div>
                <div>
                    <h2>E-library service</h2>
                </div>
                <div>
                    <p>E-soma offers students the opportunity to download academic content ranging from past papers to revision notes from the comfort of their own homes.</p>
                </div>
                <div>
    ...
    <div class="footer">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#014773" fill-opacity="1" d="M0,96L40,96C80,96,160,96,240,117.3C320,139,400,181,480,176C560,171,640,117,720,96C800,75,880,85,960,101.3C1040,117,1120,139,1200,128C1280,117,1360,75,1400,53.3L1440,32L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>

        <div class="below-the-fold-2">
            <div class="footer-section">
                <div class="logo"><a>E-s<span>o</span>ma</a></div>
                <div><p>© 2018 - 2021 Esoma Solutions. All Rights Reserved</p></div>
            </div>
            <div class="footer-section second-footer-section">
            <div><h3>About Esoma-KE</h3></div>
                <div class="about-us-li">
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.5 6.75C13.5 10.4779 10.4779 13.5 6.75 13.5C3.02208 13.5 0 10.4779 0 6.75C0 3.02208 3.02208 0 6.75 0C10.4779 0 13.5 3.02208 13.5 6.75ZM7.5 3.75C7.5 4.16421 7.16421 4.5 6.75 4.5C6.33579 4.5 6 4.16421 6 3.75C6 3.33579 6.33579 3 6.75 3C7.16421 3 7.5 3.33579 7.5 3.75ZM7.5 10.5V6H6V10.5H7.5Z" fill="white"/></svg>
                    <div><a>About us</a></div>
                </div>
                <div class="about-us-li">
                    <svg width="14" height="14" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 6.00003L5.71249 7.71252C5.86123 7.86126 6.10886 7.83674 6.22554 7.66172L8.66666 4.00003M6.26261 0.779245L10.2055 2.46907C10.4786 2.5861 10.6413 2.86972 10.6044 3.16452L10.1958 6.43378C10.07 7.44018 9.56656 8.36122 8.7874 9.01052L6.42679 10.9777C6.17955 11.1837 5.82044 11.1837 5.57321 10.9777L3.21259 9.01052C2.43343 8.36122 1.93002 7.44018 1.80421 6.43378L1.39556 3.16452C1.35871 2.86971 1.52138 2.5861 1.79446 2.46907L5.73738 0.779245C5.90508 0.707374 6.09491 0.707374 6.26261 0.779245Z" stroke="white" stroke-width="1.33333" stroke-linecap="round"/></svg>
                    <div><a>Privacy Policy</a></div>
                </div>
                <div class="about-us-li">
                    <svg width="14" height="14" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.0625 10H9C10.1785 10 10.7678 10 11.1339 9.63388C11.5 9.26777 11.5 8.67851 11.5 7.5V4.375C11.5 3.19649 11.5 2.60723 11.1339 2.24112C10.7678 1.875 10.1785 1.875 9 1.875H4C2.82149 1.875 2.23223 1.875 1.86612 2.24112C1.5 2.60723 1.5 3.19649 1.5 4.375V11.5625C1.5 10.6996 2.19956 10 3.0625 10ZM9.78921 6.41421C10.5703 5.63317 10.5703 4.36684 9.78921 3.58579C9.00817 2.80474 7.74184 2.80474 6.96079 3.58579L5.86557 4.68101C5.08051 4.05869 3.93629 4.11028 3.21079 4.83579C2.42974 5.61683 2.42974 6.88316 3.21079 7.66421L3.75368 8.20711C4.92525 9.37868 6.82475 9.37868 7.99632 8.20711L9.78921 6.41421Z" fill="white"/><path d="M11.5 13.125H5.25M3.0625 10H9C10.1785 10 10.7678 10 11.1339 9.63388C11.5 9.26777 11.5 8.67851 11.5 7.5V4.375C11.5 3.19649 11.5 2.60723 11.1339 2.24112C10.7678 1.875 10.1785 1.875 9 1.875H4C2.82149 1.875 2.23223 1.875 1.86612 2.24112C1.5 2.60723 1.5 3.19649 1.5 4.375V11.5625C1.5 10.6996 2.19956 10 3.0625 10ZM9.78921 6.41421C10.5703 5.63317 10.5703 4.36684 9.78921 3.58579C9.00817 2.80474 7.74184 2.80474 6.96079 3.58579L5.86557 4.68101C5.08051 4.05869 3.93629 4.11028 3.21079 4.83579C2.42974 5.61683 2.42974 6.88316 3.21079 7.66421L3.75368 8.20711C4.92525 9.37868 6.82475 9.37868 7.99632 8.20711L9.78921 6.41421Z" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>
                    <div><a>Our Terms of Service</a></div>
                </div>
            </div>
            <div class="footer-section second-footer-section">
                <div><h3>Our Socials</h3></div>
                <div>
                    <a>Facebook</a>
                </div>
                <div>
