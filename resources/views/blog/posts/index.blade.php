...
<body class="">
	...
	<div class="w-100vw flex">
		<div class="w-[20%] bg-sky-900 text-white">
			<ul class="flex flex-col w-full items-center">
				...
				<div class="flex flex-col gap-3 rounded-md p-3 pb-[1000px]">
					...
					<a href="#" class="w-[250px] rounded-md px-4 py-3 bg-cyan-600"><i
		...
		<div class="w-[80%] flex p-40 bg-slate-50">
			<div class="w-full flex flex-col gap-10">
				...
				<a href="{{ route('blog.posts.show', $post->id)}}" class="hover:-translate-y-1 transition">
					<div class="bg-white shadow-md rounded-md flex gap-x-10 hover:shadow-lg transition">
						...
						<div class="w-[60%] flex flex-col items-start pr-10 py-5 gap-y-5">
							<div class="tags">
							...
							<p class="text-zinc-600">
								{{substr(strip_tags($post->content), 0, 250) }}{{ strlen(strip_tags($post->content)) >
								250 ?
								'...' :
								"" }}
							</p>
			...
			<div class="w-[40%]">
				...
				<div class="flex flex-col items-center gap-4 w-full">
					<a class="font-semibold text-zinc-600 py-2 w-[80%] bg-white rounded-md pl-8 shadow-md hover:shadow-lg transition"
